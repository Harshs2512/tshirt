...
const UserSd = () => {
    ...
    return (
        <div className='grid grid-rows-3 bg-white p-3 border-r-2 border-gray-400'>
            ...
            <NavLink to="/account/profile" className='bg-gray-200 mt-10 pt-3 font-medium text-stone-800 focus:border-1 focus:border-red-400'>
                <div className='flex ml-5'>
                    <span className='mr-2'><UilUser /></span>Your Profile
                </div>
            </NavLink>
            <NavLink to="/account/orders" className='bg-gray-200 mt-10 pt-3 font-medium text-stone-800 focus:border-1 focus:border-red-400'>
                <div className='flex ml-5'>
